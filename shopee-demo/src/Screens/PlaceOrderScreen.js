      ...
      <div className="content">
        <div className="grid">
          <div className="grid__row padding-top ">
            <div className="cart-item-heading cart-item-heading-address">
              <div className="grid__column-2">
                <i className="cart-item-heading-address-icon fas fa-map-marker-alt"></i>
                &nbsp;
                <span className="cart-item-heading-address-title">Địa chỉ nhận hàng</span>
              </div>
              <div className="grid__column-10">
                <div className="cart-item-heading cart-item-heading-address-info">
                  <div className="grid__column-10-3">
                    <div className="cart-item-heading-left cart-item-heading-address-info-name">Đỗ Vững +0981007340</div>
                  </div>
                  <div className="grid__column-10-7">
                    <div className="cart-item-heading-left ">{cart.shipping.address}</div>
                  </div>
                  <div className="grid__column-10-2">
                    <Link to="/shipping" className="cart-item-heading-left cart-item-heading-address-info-change">
                      Thay đổi
                    </Link>
                  </div>
                </div>
            ...
            <div className="cart-item-heading cart-item-heading-address">
              <div className="grid__column-2">
                <i class="cart-item-heading-address-icon fas fa-wallet"></i>
                &nbsp;
                <span className="cart-item-heading-address-title">Phương thức thanh toán</span>
              </div>
              <div className="grid__column-10">
                <div className="cart-item-heading cart-item-heading-address-info">
                  <div className="grid__column-10-3"></div>
                  <div className="grid__column-10-7">
                    <div className="cart-item-heading-left ">{cart.payment.paymentMethod}</div>
                  </div>
                  <div className="grid__column-10-2">
                    <Link to="/payment" className="cart-item-heading-left cart-item-heading-address-info-change">
                      Thay đổi
                    </Link>
                  </div>
                </div>
            ...
            <div className="cart-item-heading">
              ...
              <div className="grid__column-6">
                <div className="cart-item-heading-left">
                  ...
                  <div className="grid__column-6-4">
                    <span className="cart-item-heading-left-action">Shipping</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              {cartItems.length === 0 ? (
                ...
                cartItems.map((item, index) => (
                  <li key={index} className="cart-item-content">
                    <div className="grid__column-6">
                      <a className="cart-item-content-product">
                        <img className="cart-item-content-img" src={item.image} alt="" />
            ...
            <div className="cart-item-content-checkout">
              ...
              <button onClick={handleConfirmBuy} className="btn btn--primary">
                Xác nhận đặt hàng
              </button>
            </div>
          </div>
