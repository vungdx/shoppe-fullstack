        ...
        <nav className="header__navbar">
          <ul className="header__navbar-list">
            ...
            <li className="header__navbar-item">
              ...
              <a href className="header__navbar-item-link"><i className="icon fab fa-facebook" /></a>
              <a href className="header__navbar-item-link"><i className="icon fab fa-instagram" /></a>
            </li>
          </ul>
          <ul className="header__navbar-list">
            <li className="header__navbar-item">
              ...
              <div className="notify">
                ...
                <ul className="notify-list">
                  <li className="notify-item">
                    <a href className="notify-link view">
                      ...
                      <div className="notify-link-info">
                        ...
                        <span className="notify-info-desc">Được chiết xuất 100% nước hoa đến từ
                        </span>
                      </div>
                    </a>
                  </li>
            ...
            <li className="header__navbar-item bold separate">Đăng ký</li>
            <li className="header__navbar-item bold">Đăng nhập</li>
          </ul>
        </nav>
        <div className="header-with-search">
          ...
          <div className="header__search">
            ...
            <div className="header__search-select">
              ...
              <i className="header__search-icon fas fa-chevron-down" />
              <ul className="header__search-option">
                <li className="header__search-option-item active">
                  <span className="search-option-item-label">
                    Trong shop
                  </span>
        ...
        <div className="grid__row padding-top">
            ...
            <nav className="category">
              ...
              <ul className="category-list">
                ...
                <li className="category-item">
                  <a href className="category-item__link">Trang điểm mũi</a>
                </li>
                <li className="category-item">
          ...
          <div className="grid__column-10">
            <div className="home-filter">
              ...
              <div className="home-filter__page">
                ...
                <div className="home-filter__page-control">
                  <a href className="home-filter__page-btn disabled">
            ...
            <ul className="pagination margin-pagination">
              ...
              <li className="pagination-item">
                <a href className="pagination-item__link cursor_default">...</a>
              </li>
              <li className="pagination-item">
                <a href className="pagination-item__link">15</a>
              </li>
              <li className="pagination-item">
                <a href className="pagination-item__link">
