            ...
            <nav className="header__navbar">
              ...
              <div className="header__qr-code">
                ...
                <li className="header__navbar-item">
                  ...
                  <a className="header__navbar-item-link"><i className="icon fab fa-facebook" /></a>
                  <a className="header__navbar-item-link"><i className="icon fab fa-instagram" /></a>
                </li>
              </ul>
              <ul className="header__navbar-list">
                <li className="header__navbar-item">
